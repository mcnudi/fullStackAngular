...
export class RutinaComponent {
  ...
  constructor() {
    this.rutinaForm = new FormGroup({
      name: new FormControl(this.valor?.name || '', [
        Validators.required,
        this.textoValidator,
      ]),
      descripcion: new FormControl(this.valor?.description || '', [
        Validators.required,
        this.textoValidator,
      ]),
    ...
    if (this.irutina) {
      ...
      if (this.url.startsWith('/app/anadirRutina/usuario')) {
        ...
        this.serviceRutina.modificarRutina(this.irutina).subscribe({
          ...
          error: (err) => {
            console.error('Error al modificar la rutina:', err),
